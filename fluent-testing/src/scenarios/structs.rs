...
pub enum ExceptionalContext {
    ...
    None,
    /// Value is missing from a resource and should cause a fallback.
    ValueMissingFromResource,
    /// Values is missing from all resources in all locales.
    ValueMissingFromAllResources,
    /// Optional resource is missing from the top locale.
    OptionalResourceMissingFromLocale,
    /// Optional resource is missing from all locales.
    OptionalResourceMissingFromAllLocales,
    /// Required resource is missing from the top locale.
    RequiredResourceMissingFromLocale,
    /// Required resource is missing from all locales.
...
impl ExceptionalContext {
    ...
    /// This query will result in no bundles being generated.
